...
public class TenantIDGrpcClientInterceptor implements ClientInterceptor {

    private final Supplier<String> tenantSupplier;

    public TenantIDGrpcClientInterceptor(Supplier<String> tenantSupplier) {
    ...
    public <ReqT, RespT> ClientCall<ReqT, RespT> interceptCall(
        ...
        return new SimpleForwardingClientCall<>(next.newCall(method, callOptions)) {
            ...
            public void start(Listener<RespT> responseListener, Metadata headers) {
                String tenantId = Optional.ofNullable(tenantSupplier.get())
