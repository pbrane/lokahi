...
public interface PassiveDiscoveryMapper {
    ...
    @Mapping(target = "locations", source = "locationsList")
    ...
    PassiveDiscoveryCreateDTO discoveryCreateToProto(PassiveDiscoveryCreate request);

    default PassiveDiscoveryCreateDTO discoveryCreateToProtoCustom(PassiveDiscoveryCreate request) {
        PassiveDiscoveryCreateDTO.Builder builder = discoveryCreateToProto(request).toBuilder();
        builder.addAllLocations(request.getLocations());
