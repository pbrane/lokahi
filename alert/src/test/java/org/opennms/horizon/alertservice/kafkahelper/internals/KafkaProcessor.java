...
package org.opennms.horizon.alertservice.kafkahelper.internals;
...
public class KafkaProcessor<K,V> implements Runnable {
    ...
    public KafkaProcessor(KafkaConsumer<K,V> consumer, KafkaProducer<K,V> kafkaProducer, Consumer<ConsumerRecords<K,V>> onRecords) {
