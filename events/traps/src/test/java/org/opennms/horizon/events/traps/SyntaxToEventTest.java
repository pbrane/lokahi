...
public class SyntaxToEventTest {
    ...
    public void testProcessSyntaxZeros() {
        ...
        Parm parm = SyntaxToEvent.processSyntax("Test", octetString).get();
    ...
    public void testProcessSyntaxForMacAddresses() {
        ...
        Parm parm = SyntaxToEvent.processSyntax("testMacAddress", octetString).get();
        ...
        parm = SyntaxToEvent.processSyntax("testMacAddress", octetString).get();
        ...
        parm = SyntaxToEvent.processSyntax("otherDataType", octetString).get();
    ...
    public void testProcessSyntaxForUnprintableBytes() {
        ...
        Parm parm = SyntaxToEvent.processSyntax("testOtherData", octetString).get();
        ...
        parm = SyntaxToEvent.processSyntax("testSomeMacAddress", octetString).get();
