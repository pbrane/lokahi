...
package org.opennms.horizon.graph.rest.renderer;
...
import org.opennms.horizon.graph.api.renderer.GraphRenderer;
import org.opennms.horizon.graph.rest.converter.JsonConverterService;
    ...
    public String render(int identation, List<GraphContainerInfo> containerInfos) {
        ...
        containerInfos.stream()
            ...
            .forEach(containerInfo -> {
                final JSONObject jsonGraphContainerInfoObject =
                    new JsonConverterService(bundleContext).convert(containerInfo);
