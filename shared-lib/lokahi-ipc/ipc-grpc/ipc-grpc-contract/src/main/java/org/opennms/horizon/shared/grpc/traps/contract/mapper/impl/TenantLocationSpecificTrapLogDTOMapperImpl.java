...
public class TenantLocationSpecificTrapLogDTOMapperImpl implements TenantLocationSpecificTrapLogDTOMapper {
    ...
    public TenantLocationSpecificTrapLogDTO mapBareToTenanted(String tenantId, String locationId, TrapLogDTO bare) {
        ...
        var result = TenantLocationSpecificTrapLogDTO.newBuilder()
    ...
    @Override
    public TrapLogDTO mapTenantedToBare(TenantLocationSpecificTrapLogDTO tenantLocationSpecific) {
        var result = TrapLogDTO.newBuilder()
                .setIdentity(tenantLocationSpecific.getIdentity())
                .setTrapAddress(tenantLocationSpecific.getTrapAddress())
                .addAllTrapDTO(tenantLocationSpecific.getTrapDTOList())
                .build();
