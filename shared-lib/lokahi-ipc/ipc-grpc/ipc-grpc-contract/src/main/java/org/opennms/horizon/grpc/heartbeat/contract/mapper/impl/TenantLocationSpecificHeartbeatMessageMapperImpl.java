...
public class TenantLocationSpecificHeartbeatMessageMapperImpl implements TenantLocationSpecificHeartbeatMessageMapper {
    @Override
    public TenantLocationSpecificHeartbeatMessage mapBareToTenanted(
            String tenantId, String locationId, HeartbeatMessage bare) {
        TenantLocationSpecificHeartbeatMessage result = TenantLocationSpecificHeartbeatMessage.newBuilder()
    ...
    @Override
    public HeartbeatMessage mapTenantedToBare(
            TenantLocationSpecificHeartbeatMessage tenantLocationSpecificHeartbeatMessage) {
        HeartbeatMessage result = HeartbeatMessage.newBuilder()
