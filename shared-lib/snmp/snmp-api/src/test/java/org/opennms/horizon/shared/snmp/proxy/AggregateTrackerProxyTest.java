...
import org.opennms.horizon.shared.snmp.GatheringTracker;
...
public class AggregateTrackerProxyTest {
    ...
    public void setUp() {
        ...
        MatcherAssert.assertThat(parentAggregateTracker.getWalkRequests(), hasSize(4));
        MatcherAssert.assertThat(parentAggregateTracker.getWalkRequests(), contains(expectedRequests.toArray()));
