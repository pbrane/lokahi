...
public interface SnmpProfileMapper {
     ...
     */
    CompletableFuture<Optional<SnmpAgentConfig>> getAgentConfigFromProfiles(
            InetAddress inetAddress, String location, String oid);
     ...
     * @return snmpAgentConfig, a @{@link SnmpAgentConfig} from the matching profile.
     */
    CompletableFuture<Optional<SnmpAgentConfig>> fitProfile(
