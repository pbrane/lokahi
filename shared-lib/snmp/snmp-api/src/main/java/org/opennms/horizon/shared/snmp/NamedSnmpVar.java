...
public class NamedSnmpVar {
     ...
     * <p>getSnmpObjId</p>
     *
     * @return a {@link SnmpObjId} object.
     */
     ...
     * @param instances a {@link java.util.Set} object.
     * @return an array of {@link CollectionTracker} objects.
     */
    public static CollectionTracker[] getTrackersFor(final NamedSnmpVar[] columns, final Set<SnmpInstId> instances) {
        ...
        for (int i = 0; i < columns.length; i++) trackers[i] = columns[i].getCollectionTracker(instances);
