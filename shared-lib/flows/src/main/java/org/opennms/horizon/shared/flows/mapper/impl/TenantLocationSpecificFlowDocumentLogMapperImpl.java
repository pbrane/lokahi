...
public class TenantLocationSpecificFlowDocumentLogMapperImpl implements TenantLocationSpecificFlowDocumentLogMapper {
    @Override
    public TenantLocationSpecificFlowDocumentLog mapBareToTenanted(
            String tenantId, String location, FlowDocumentLog flowDocumentLog) {
    ...
    @Override
    public FlowDocumentLog mapTenantedToBare(
            TenantLocationSpecificFlowDocumentLog tenantLocationSpecificFlowDocumentLog) {
