...
public class NullPinger implements Pinger {
    private static final UnsupportedOperationException UNSUPPORTED =
            new UnsupportedOperationException("ICMP is not available.");
    ...
    public void ping(
            ...
            throws Exception {
        LOG.trace(
                "ping: host={}, timeout={}, retries={}, packetsize={}, sequenceId={}, callback={}",
                host,
                timeout,
                retries,
                packetsize,
    ...
    public void ping(InetAddress host, long timeout, int retries, int sequenceId, PingResponseCallback cb)
            throws Exception {
        LOG.trace(
                "ping: host={}, timeout={}, retries={}, sequenceId={}, callback={}",
                host,
                timeout,
                retries,
                sequenceId,
    ...
    public List<Number> parallelPing(InetAddress host, int count, long timeout, long pingInterval, int size)
            throws Exception {
        LOG.trace(
                "parallel-ping: host={}, count={}, timeout={}, interval={}, size={}",
                host,
                count,
                timeout,
                pingInterval,
