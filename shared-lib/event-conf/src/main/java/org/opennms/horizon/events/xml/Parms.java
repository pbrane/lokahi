...
public class Parms implements Serializable {
     ...
     */
    public void addParm(final Parm vParm) throws IndexOutOfBoundsException {
     ...
     * given is outside the bounds of the collection
     */
    public void addParm(final int index, final Parm vParm) throws IndexOutOfBoundsException {
     ...
     * at the given index
     */
    public Parm getParm(final int index) throws IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this._parmList.size()) {
            throw new IndexOutOfBoundsException(
                    "getParm: Index value '" + index + "' not in range [0.." + (this._parmList.size() - 1) + "]");
        }
     ...
     */
    public boolean removeParm(final Parm vParm) {
     ...
     */
    public Parm removeParmAt(final int index) {
     ...
     * given is outside the bounds of the collection
     */
    public void setParm(final int index, final Parm vParm) throws IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this._parmList.size()) {
            throw new IndexOutOfBoundsException(
     ...
     */
    public void setParm(final java.util.List<Parm> vParmList) {
        // copy vector
        this._parmList.clear();
     ...
     */
    public void setParmCollection(final java.util.List<Parm> parmList) {
