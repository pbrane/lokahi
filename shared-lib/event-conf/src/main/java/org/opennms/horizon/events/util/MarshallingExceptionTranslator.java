...
public class MarshallingExceptionTranslator {
     ...
     * <p>translate</p>
     *
     * @param task a {@link String} object.
     * @param e a {@link IOException} object.
     * @return a {@link DataAccessException} object.
     */
    ...
    public DataAccessException translate(final String task, final Exception e) {
        return new MarshallingResourceFailureException(
                "Failed to marshal/unmarshal XML file while " + task + ": " + e, e);
    }
