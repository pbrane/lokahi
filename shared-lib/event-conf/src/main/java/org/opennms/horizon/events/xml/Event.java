...
public class Event implements Serializable {
    ...
    public String getLoggroup(final int index) throws IndexOutOfBoundsException {
        ...
        if (index < 0 || index >= _loggroupList.size()) {
            throw new IndexOutOfBoundsException(
                    "getLoggroup: Index value '" + index + "' not in range [0.." + (_loggroupList.size() - 1) + "]");
        }
     ...
     * the format generated by the {@link DateFormat} using the
     ...
     *
     * @see <a href="https://issues.opennms.org/browse/NMS-3561">...</a>
     *
    ...
    public void setLoggroup(final int index, final String vLoggroup) throws IndexOutOfBoundsException {
        ...
        if (index < 0 || index >= _loggroupList.size()) {
            throw new IndexOutOfBoundsException(
                    "setLoggroup: Index value '" + index + "' not in range [0.." + (_loggroupList.size() - 1) + "]");
        }
    ...
    public String toString() {
        return new StringJoiner(", ", Event.class.getSimpleName() + "[", "]")
                .add("uuid='" + _uuid + "'")
                .add("dbid=" + _dbid)
                .add("distPoller='" + _distPoller + "'")
                .add("creationTime=" + _creationTime)
                .add("masterStation='" + _masterStation + "'")
                .add("mask=" + _mask)
                .add("uei='" + _uei + "'")
                .add("source='" + _source + "'")
                .add("nodeid=" + _nodeid)
                .add("time=" + _time)
                .add("host='" + _host + "'")
                .add("interfaceAddress=" + _interfaceAddress)
                .add("interfaceString='" + _interfaceString + "'")
                .add("snmphost='" + _snmphost + "'")
                ...
                .add("autoactionList=" + _autoactionList)
                .add("operactionList=" + _operactionList)
                .add("autoacknowledge=" + _autoacknowledge)
                .add("loggroupList=" + _loggroupList)
                .add("tticket=" + _tticket)
                .add("forwardList=" + _forwardList)
                .add("scriptList=" + _scriptList)
