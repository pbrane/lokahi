...
public class Correlation implements Serializable {
     ...
     */
    public void addCuei(final String vCuei) throws IndexOutOfBoundsException {
     ...
     * given is outside the bounds of the collection
     */
    public void addCuei(final int index, final String vCuei) throws IndexOutOfBoundsException {
     ...
     */
    public boolean removeCuei(final String vCuei) {
     ...
     * given is outside the bounds of the collection
     */
    public void setCuei(final int index, final String vCuei) throws IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this._cueiList.size()) {
            throw new IndexOutOfBoundsException(
     ...
     */
    public void setCuei(final java.util.List<String> vCueiList) {
        // copy vector
        this._cueiList.clear();
     ...
     */
    public void setCueiCollection(final java.util.List<String> cueiList) {
