...
public class Maskelement implements Serializable {
    ...
    public boolean equals(final Object obj) {
        ...
        if (obj instanceof Maskelement) {
            ...
            return Objects.equals(this.m_name, that.m_name) && Objects.equals(this.m_values, that.m_values);
        }
        return false;
    }
    ...
    public EventMatcher constructMatcher() {
        ...
        for (String value : m_values) {
            ...
            if (value.startsWith("~")) {
                valueMatchers.add(EventMatchers.valueMatchesRegexMatcher(EventMatchers.field(m_name), value));
            } else if (value.endsWith("%")) {
                valueMatchers.add(EventMatchers.valueStartsWithMatcher(EventMatchers.field(m_name), value));
            } else {
                valueMatchers.add(EventMatchers.valueEqualsMatcher(EventMatchers.field(m_name), value));
            }
        }
