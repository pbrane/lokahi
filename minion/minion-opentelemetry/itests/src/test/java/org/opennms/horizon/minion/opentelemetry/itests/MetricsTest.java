package org.opennms.horizon.minion.opentelemetry.itests;
...
public class MetricsTest {
    ...
    public Option[] configuration() {
        ...
        KarafFeaturesOption bootFeatures = new KarafFeaturesOption(
            maven("org.opennms.horizon.minion.opentelemetry", "features").classifier("features").type("xml").versionAsInProject(),
