...
public class PluginRegistrationRoutingTest extends CamelTestSupport {
    ...
    public RouteBuilder createRouteBuilder() throws Exception {
        when(messageDispatcherFactory.createSyncDispatcher(any(PluginConfigSinkModule.class)))
    ...
    public void goodDetection() throws Exception {
        ...
        NotifyBuilder notify = new NotifyBuilder(context())
                .fromRoute(PluginRegistrationRouting.ROUTE_ID)
                .waitTime(aggregationDelay + additionalTestDelay)
                .whenDone(1)
                .create();
