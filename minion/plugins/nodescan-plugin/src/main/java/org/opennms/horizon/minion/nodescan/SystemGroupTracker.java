...
import org.opennms.horizon.shared.snmp.ErrorStatusException;
import org.opennms.horizon.shared.snmp.NamedSnmpVar;
import org.opennms.horizon.shared.snmp.SnmpResult;
import org.opennms.horizon.shared.snmp.SnmpStore;
import org.opennms.node.scan.contract.NodeInfoResult;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class SystemGroupTracker extends AggregateTracker {
    private static final Logger LOG = LoggerFactory.getLogger(SystemGroupTracker.class);
     ...
     * @param address TODO
     */
    public SystemGroupTracker(InetAddress address) {
    ...
    protected void reportNonFatalErr(final ErrorStatus status) {
        LOG.info(
                "Error ({}) retrieving systemGroup from {}. {}",
                status,
                m_address,
                status.retry() ? "Retrying." : "Giving up.");
    }

    public NodeInfoResult createNodeInfo() {
