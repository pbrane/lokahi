...
public class TimeoutTracker {
     ...
     */
    public TimeoutTracker(final HttpMonitorRequest httpMonitorRequest, int defaultRetry, int defaultTimeout) {
        m_retry = httpMonitorRequest.getRetry() != 0 ? httpMonitorRequest.getRetry() : defaultRetry;

        // make sure the timeout is a least 10 millis
        m_timeoutInMillis =
                Math.max(10L, httpMonitorRequest.getTimeout() != 0 ? httpMonitorRequest.getTimeout() : defaultTimeout);
    ...
    public void startAttempt() {
        ...
        while (now < m_nextRetryTimeNanos) {
