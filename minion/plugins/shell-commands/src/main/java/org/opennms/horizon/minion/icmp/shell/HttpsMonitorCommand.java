...
@Command(scope = "opennms", name = "https-monitor", description = "Monitor https services.")
@Service
public class HttpsMonitorCommand implements Action {
    @Reference
    ...
    public Object execute() {
        ...
        var httpMonitorManager = monitorRegistry.getService("HTTPSMonitor");
