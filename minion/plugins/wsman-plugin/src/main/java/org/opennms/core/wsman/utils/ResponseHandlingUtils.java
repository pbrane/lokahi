...
public class ResponseHandlingUtils {
    ...
    public static int getMatchingIndex(String spelExpression, ListMultimap<String, String> values)
    ...
    private static int getMatchingIndex(Expression exp, ListMultimap<String, String> valuesByName, int depth)
            throws NoSuchElementException {
        ...
        try {
            ...
            //            LOG.error("Failed to evaluate expression {}. Msg: {}", exp.getExpressionString(),
            // e.getMessage());
    ...
    public static boolean matchesFilter(String spelFilter, ListMultimap<String, String> valuesByName) {
        ...
        try {
            ...
            LOG.error(
                    "Failed to evaluate expression {}. Assuming match is negative. Msg: {}",
