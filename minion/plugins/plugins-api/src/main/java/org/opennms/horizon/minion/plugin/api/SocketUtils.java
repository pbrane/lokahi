...
public abstract class SocketUtils {
    ...
    public static SSLSocket wrapSocketInSslContext(Socket socket, String protocol, String[] cipherSuites)
            throws IOException {
     ...
     */
    public static boolean validResponse(String request, String responsePattern, BufferedReader r, Writer wr)
            throws IOException {
