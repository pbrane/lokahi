...
public class PlainTextChannelFactory implements ManagedChannelFactory {

    private final ChannelBuilderFactory channelBuilderFactory;

    public PlainTextChannelFactory(ChannelBuilderFactory channelBuilderFactory) {
    ...
    public ManagedChannel create(String hostname, int port, String authority) {
        return channelBuilderFactory
                .create(hostname, port, authority, null)
                .usePlaintext()
                .build();
    }
}
