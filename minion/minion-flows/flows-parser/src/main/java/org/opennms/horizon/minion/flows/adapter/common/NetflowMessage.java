...
public class NetflowMessage implements Flow {
    ...
    public Direction getDirection() {
        return switch (flowMessageProto.getDirection()) {
            case INGRESS -> Direction.INGRESS;
            case EGRESS -> Direction.EGRESS;
    ...
    public NetflowVersion getNetflowVersion() {
        return switch (flowMessageProto.getNetflowVersion()) {
            case V9 -> NetflowVersion.V9;
            case IPFIX -> NetflowVersion.IPFIX;
            default -> NetflowVersion.V5;
        };
    }
