...
public class UndeclaredValue extends Value<byte[]> {
    ...
    public UndeclaredValue(final Optional<Long> enterpriseNumber, final int informationElementId, final byte[] value) {
        ...
        return new InformationElement() {
            ...
            public Value<?> parse(final Session.Resolver resolver, final ByteBuf buffer) {
                return new UndeclaredValue(
                        enterpriseNumber, informationElementId, bytes(buffer, buffer.readableBytes()));
            }
    ...
    public static String nameFor(final Optional<Long> enterpriseNumber, final int informationElementId) {
