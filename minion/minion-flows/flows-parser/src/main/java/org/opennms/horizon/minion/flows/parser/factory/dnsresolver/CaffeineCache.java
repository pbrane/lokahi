        ...
        final Caffeine<String, Entries<E>> caffeine = Caffeine.newBuilder()
                .expireAfter(new Expiry<String, Entries<E>>() {
                    ...
                    public long expireAfterUpdate(
                            String key, Entries<E> value, long currentTime, long currentDuration) {
                        // The value has been updated and may now contain an entry with a shorter TTL then what we
                        // originally used
