...
public class UnsignedValue extends Value<UnsignedLong> {
    ...
    public UnsignedValue(final String name, final Optional<Semantics> semantics, final UnsignedLong value) {
        super(name, semantics);
        this.value = Objects.requireNonNull(value);
    }

    public UnsignedValue(final String name, final long value) {
