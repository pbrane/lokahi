...
public class BooleanValue extends Value<Boolean> {
    ...
    public BooleanValue(final String name, final Optional<Semantics> semantics, final boolean value) {
            ...
            public Value<?> parse(final Session.Resolver resolver, final ByteBuf buffer) throws InvalidPacketException {
                ...
                if (value < 1 || value > 2) {
                    throw new InvalidPacketException(
                            buffer, "Illegal value '%d' for boolean type (only 1/true and 2/false allowed)", value);
                }
