...
public class FloatValue extends Value<Double> {
    ...
    public FloatValue(final String name, final Optional<Semantics> semantics, final double value) {
            ...
            public Value<?> parse(final Session.Resolver resolver, final ByteBuf buffer) {
                return new FloatValue(
                        ...
                        Float.intBitsToFloat(
                                uint(buffer, buffer.readableBytes()).intValue()));
            }
            ...
            public Value<?> parse(final Session.Resolver resolver, final ByteBuf buffer) {
                return new FloatValue(
                        ...
                        Double.longBitsToDouble(
                                uint(buffer, buffer.readableBytes()).longValue()));
            }
