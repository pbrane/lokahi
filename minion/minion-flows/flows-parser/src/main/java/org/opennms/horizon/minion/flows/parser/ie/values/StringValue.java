...
public class StringValue extends Value<String> {
    ...
    public StringValue(final String name, final Optional<Semantics> semantics, final String value) {
        ...
        return new InformationElement() {
            ...
            public Value<?> parse(final Session.Resolver resolver, final ByteBuf buffer) {
                return new StringValue(
                        name, semantics, new String(bytes(buffer, buffer.readableBytes()), UTF8_CHARSET));
            }
