...
public class IPPollRange implements Iterable<IPPollAddress>, Serializable {
    ...
    final class IPPollRangeGenerator implements Enumeration<IPPollAddress>, Iterator<IPPollAddress> {
        ...
        public IPPollAddress nextElement() {
            return new IPPollAddress(
                    m_foreignSource, m_location, (InetAddress) m_range.nextElement(), m_timeout, m_retries);
        }
     ...
     */
    public IPPollRange(String foreignSource, String location, String fromIP, String toIP, long timeout, int retries)
     ...
     */
    public IPPollRange(
            String foreignSource, String location, InetAddress start, InetAddress end, long timeout, int retries) {
