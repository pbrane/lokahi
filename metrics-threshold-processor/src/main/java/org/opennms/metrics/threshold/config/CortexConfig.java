...
public class CortexConfig {
    ...
    @Value("${horizon.cortex.retry.delay:1000}")
    private int retryDelay;

    @Value("${horizon.cortex.retry.maxDelay:60000}")
    private int maxRetryDelay;

    @Value("${horizon.cortex.retry.multiplier:2}")
    private int retryMultiplier;

    @Value("${horizon.cortex.retry.max:10}")
    ...
    public RetryTemplate retryTemplate() {
        ...
        return RetryTemplate.builder()
                .retryOn(MetricsThresholdAPIRetryableException.class)
