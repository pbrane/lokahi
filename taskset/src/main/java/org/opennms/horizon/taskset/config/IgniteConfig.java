...
public class IgniteConfig {
    ...
    private IgniteConfiguration prepareIgniteConfiguration() {        org.apache.ignite.configuration.IgniteConfiguration igniteConfiguration = new org.apache.ignite.configuration.IgniteConfiguration();
