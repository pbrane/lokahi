...
public class ClassificationRequest {
    ...
    public ClassificationRequest(
            String location, int srcPort, IpAddr srcAddress, int dstPort, IpAddr dstAddress, Protocol protocol) {
    ...
    public String toString() {
        return "ClassificationRequest{" + "location='"
                + location + '\'' + ", protocol="
                + protocol + ", dstPort="
                + dstPort + ", dstAddress='"
                + dstAddress + '\'' + ", srcPort="
                + srcPort + ", srcAddress='"
                + srcAddress + '\'' + ", exporterAddress='"
                + exporterAddress + '\'' + '}';
    }
}
