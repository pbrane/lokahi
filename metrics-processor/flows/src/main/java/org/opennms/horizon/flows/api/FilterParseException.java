 ...
 * License.
 */
package org.opennms.horizon.flows.api;
...
public class FilterParseException extends RuntimeException {
    ...
    public void printStackTrace() {
        if (m_delegate != null) m_delegate.printStackTrace();
    ...
    public void printStackTrace(PrintStream ps) {
        if (m_delegate != null) m_delegate.printStackTrace(ps);
    ...
    public void printStackTrace(PrintWriter pw) {
        if (m_delegate != null) m_delegate.printStackTrace(pw);
