...
public abstract class Bound<T extends Comparable<T>> {
    ...
    public static class Lt<T extends Comparable<T>> extends Bound<T> {
        ...
        public Bound<T> lt(T value) {
            if (lt.compareTo(value) <= 0) {
                throw new IllegalArgumentException(
                        "restriction must be smaller than current value - current: " + lt + "; restriction: " + value);
            }
            return new Lt<>(value);
        }
        ...
        public Bound<T> eq(T value) {
            if (lt.compareTo(value) < 0) {
                throw new IllegalArgumentException(
                        "illegal equality restriction - current: " + lt + "; restriction: " + value);
            }
            return new Eq<>(value);
        }
    ...
    public static class Gt<T extends Comparable<T>> extends Bound<T> {
        ...
        public Bound<T> eq(T value) {
            if (gt.compareTo(value) > 0) {
                throw new IllegalArgumentException(
                        "illegal equality restriction - current: " + gt + "; restriction: " + value);
            }
            return new Eq<>(value);
        }
        ...
        public Bound<T> gt(T value) {
            if (gt.compareTo(value) >= 0) {
                throw new IllegalArgumentException(
                        "restriction must be greater than current value - current: " + gt + "; restriction: " + value);
            }
            return new Gt<>(value);
        }
    ...
    public static class In<T extends Comparable<T>> extends Bound<T> {
        ...
        public Bound<T> eq(T value) {
            if (lt.compareTo(value) < 0 || gt.compareTo(value) > 0) {
                throw new IllegalArgumentException(
                        "illegal equality restriction - current: (" + lt + "," + gt + "); restriction: " + value);
            }
            return new Eq<>(value);
        }
