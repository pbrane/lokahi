...
import org.opennms.horizon.notifications.config.keycloak.exception.KeycloakBaseException;
 ...
 */
public class KeycloakAdminClientSession {

    public static final String BEARER_TOKEN_HEADER_SCHEME = "Bearer ";

    private static final Logger DEFAULT_LOGGER = org.slf4j.LoggerFactory.getLogger(KeycloakAdminClientSession.class);
