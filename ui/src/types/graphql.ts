...
export type AlertCondition = {
  ...
  thresholdMetric?: Maybe<ThresholdMetric>;
...
export type ListEventResponse = {
  ...
  eventsList?: Maybe<Array<Maybe<Event>>>;
  lastPage: Scalars['Long'];
  nextPage: Scalars['Long'];
  totalEvents: Scalars['Long'];
}
...
export type CountAffectedNodesByMonitoringPolicyVariables = {
  id: Maybe<Scalars['Long']>;
}
...
export type Query = {
  ...
  downloadTopN?: Maybe<DownloadResponse>;
...
export type DownloadResponse = {
  ...
  format?: Maybe<DownloadFormat>;
  responseBytes?: Maybe<Scalars['Base64String']>;
}
...
export type AlertsByNodeListQuery = { __typename?: 'Query', getAlertsByNode?: { __typename?: 'ListAlertResponse', lastPage: number, nextPage: number, totalAlerts: any, alerts?: Array<{ __typename?: 'Alert', counter: number, uei: string, acknowledged: boolean, type: string, description?: string, firstEventTimeMs: any, lastUpdateTimeMs: any, severity?: Severity, label?: string, nodeName?: string, databaseId: any, location?: string, ruleNameList?: Array<string>, policyNameList?: Array<string> }> } }
...
export type UpsertSimpleMonitoredEntityMutation = {
  __typename?: 'Mutation',
  upsertSimpleMonitoredEntity: {
    ...
    monitoredEntityId: InputMaybe<Scalars['String']>;
  };
}
export type UpsertSimpleMonitoredEntityVariables = Exact<{
  locationId?: InputMaybe<Scalars['Long']>
  name?: InputMaybe<Scalars['String']>
  type?: InputMaybe<Scalars['String']>
  config?: InputMaybe<Scalars['String']>
...
export type AllNodesStatus = { __typename?: 'Query', allNodeStatus?: Array<{ __typename?: 'NodeStatus', id: any, status?: string }> }
...
export type DownloadCSVEventVariables = Exact<{
...
export type DownloadCSVMonitoringPoliciesVariables = Exact<{
  page: Scalars['Int'];
  pageSize?: InputMaybe<Scalars['Int']>;
  sortAscending: Scalars['Boolean'];
  sortBy?: InputMaybe<Scalars['String']>;
...
export type CountAffectedNodesByMonitoringPolicyQuery = { __typename?: 'Query', getNodesCountByMonitoringPolicy: Scalars['Int'] }

export type DownloadIpInterfacesByNodeAndSearchTermQuery = { __typename?: 'Query', downloadIpInterfacesByNodeAndSearchTerm?: { __typename?: 'DownloadResponse', responseBytes?: any, format?: any } }

export type DownloadSNMPInterfacesByNodeAndSearchTermQuery = { __typename?: 'Query', downloadSnmpInterfaces?: { __typename?: 'DownloadResponse', responseBytes?: any, format?: any } }

export type DownloadTopNQuery = { __typename?: 'Query', downloadTopN?: { __typename?: 'DownloadResponse', responseBytes?: any, format?: any } }

export type DownloadAlertsByNodeAndSearchTermQuery = { __typename?: 'Query', downloadRecentAlertsByNode?: { __typename?: 'DownloadResponse', responseBytes?: any, format?: any } }

export type DownloadEventsByNodeAndSearchTermQuery = { __typename?: 'Query', downloadEventsByNodeId?: { __typename?: 'DownloadResponse', responseBytes?: any, format?: any } }

export type DownloadMonitoringPoliciesQuery = { __typename?: 'Query', searchAndDownloadMonitoringPolicies?: { __typename?: 'DownloadResponse', responseBytes?: any, format?: any } }
...
export type InventoryItemsQuery = Exact<{
  page?: Scalars['Int'];
  pageSize?: InputMaybe<Scalars['Int']>;
  sortAscending: Scalars['Boolean'];
  sortBy?: InputMaybe<Scalars['String']>;
...
export type MonitoringPolicyPartsFragment = { __typename?: 'MonitorPolicy', id?: any, memo?: string, enabled?: boolean, name?: string, notifyByEmail?: boolean, notifyByPagerDuty?: boolean, notifyByWebhooks?: boolean, tags?: Array<string>, rules?: Array<{ __typename?: 'PolicyRule', id?: any, name?: string, detectionMethod?: DetectionMethod, eventType?: EventType, thresholdMetricName?: string, alertConditions?: Array<{ __typename?: 'AlertCondition', id?: any, count?: number, overtime?: number, overtimeUnit?: string, thresholdMetric?: { __typename?: 'thresholdMetric', id?: number, enabled?: boolean, threshold?: number, condition?: string, name?: string, expression?: string },  severity?: string, clearEvent?: { __typename?: 'AlertEventDefinition', id?: any, name?: string, eventType?: EventType, uei: string }, triggerEvent?: { __typename?: 'AlertEventDefinition', id?: any, name?: string, eventType?: EventType, uei: string }, alertMessage?: string, alertRegex?: string }>, vendor?: string }> }

export type ListMonitoryPoliciesQueryVariables = Exact<{ [key: string]: never; }>

export type ListMonitoryPoliciesQuery = { __typename?: 'Query', listMonitoryPolicies?: Array<{ __typename?: 'MonitorPolicy', id?: any, memo?: string, name?: string, enabled?: boolean, notifyByEmail?: boolean, notifyByPagerDuty?: boolean, notifyByWebhooks?: boolean, tags?: Array<string>, rules?: Array<{ __typename?: 'PolicyRule', id?: any, name?: string, detectionMethod?: DetectionMethod, eventType?: EventType, thresholdMetricName?: string, alertConditions?: Array<{ __typename?: 'AlertCondition', id?: any, count?: number, overtime?: number, overtimeUnit?: string, severity?: string, thresholdMetric?: { __typename?: 'thresholdMetric', id?: number, enabled?: boolean, threshold?: number, condition?: string, name?: string, expression?: string }, clearEvent?: { __typename?: 'AlertEventDefinition', id?: any, name?: string, eventType?: EventType, uei: string }, triggerEvent?: { __typename?: 'AlertEventDefinition', id?: any, name?: string, eventType?: EventType, uei: string }, alertMessage?: string, alertRegex?: string }>, vendor?: string }> }>, defaultPolicy?: { __typename?: 'MonitorPolicy', id?: any, memo?: string, name?: string, notifyByEmail?: boolean, notifyByPagerDuty?: boolean, notifyByWebhooks?: boolean, tags?: Array<string>, rules?: Array<{ __typename?: 'PolicyRule', id?: any, name?: string, detectionMethod?: DetectionMethod, eventType?: EventType, thresholdMetricName?: string, alertConditions?: Array<{ __typename?: 'AlertCondition', id?: any, count?: number, overtime?: number, overtimeUnit?: string, severity?: string, thresholdMetric?: { __typename?: 'thresholdMetric', enabled?: boolean, threshold?: number, condition?: string }, clearEvent?: { __typename?: 'AlertEventDefinition', id?: any, name?: string, eventType?: EventType, uei: string }, triggerEvent?: { __typename?: 'AlertEventDefinition', id?: any, name?: string, eventType?: EventType, uei: string }, alertMessage?: string, alertRegex?: string }>, vendor?: string }> } }
...
export type EventsByNodeIdPartsQuery = { __typename?: 'Query', searchEvents?: { __typename?: 'ListEventResponse', nextPage: number, lastPage: number, totalEvents: number, eventsList?: Array < { __typename?: 'Event', id: number, description?: string, locationName?: string, eventLabel?: string, uei?: string, nodeId: number, ipAddress?: string, producedTime: Scalars['Long'], logMessage?: string, severity?: Severity, eventInfo?: EventInfo, eventParameter?: Array<EventParameter> } > } }
...
export const DownloadEventsDocument = {'kind': 'Document','definitions': [{'kind': 'OperationDefinition','operation': 'query','name': {'kind': 'Name','value': 'downloadEventsByNodeId'},'variableDefinitions': [{'kind': 'VariableDefinition','variable': {'kind': 'Variable','name': {'kind': 'Name','value': 'nodeId'}},'type': {'kind': 'NamedType','name': {'kind': 'Name','value': 'Long'}}}, {'kind': 'VariableDefinition','variable': {'kind': 'Variable','name': {'kind': 'Name','value': 'searchTerm'}},'type': {'kind': 'NamedType','name': {'kind': 'Name','value': 'String'}}}, {'kind': 'VariableDefinition','variable': {'kind': 'Variable','name': {'kind': 'Name','value': 'pageSize'}},'type': {'kind': 'NamedType','name': {'kind': 'Name','value': 'Int'}}}, {'kind': 'VariableDefinition','variable': {'kind': 'Variable','name': {'kind': 'Name','value': 'page'}},'type': {'kind': 'NamedType','name': {'kind': 'Name','value': 'Int!'}}}, {'kind': 'VariableDefinition','variable': {'kind': 'Variable','name': {'kind': 'Name','value': 'sortBy'}},'type': {'kind': 'NamedType','name': {'kind': 'Name','value': 'String'}}}, {'kind': 'VariableDefinition','variable': {'kind': 'Variable','name': {'kind': 'Name','value': 'sortAscending'}},'type': {'kind': 'NonNullType','type': {'kind': 'NamedType','name': {'kind': 'Name','value': 'Boolean'}}}}, {'kind': 'VariableDefinition','variable': {'kind': 'Variable','name': {'kind': 'Name','value': 'downloadFormat'}},'type': {'kind': 'NonNullType','type': {'kind': 'NamedType','name': {'kind': 'Name','value': 'DownloadFormat'}}}}],'selectionSet': {'kind': 'SelectionSet','selections': [{'kind': 'Field','name': {'kind': 'Name','value': 'downloadEventsByNodeId'},'arguments': [{'kind': 'Argument','name': {'kind': 'Name','value': 'nodeId'},'value': {'kind': 'Variable','name': {'kind': 'Name','value': 'nodeId'}}}, {'kind': 'Argument','name': {'kind': 'Name','value': 'searchTerm'},'value': {'kind': 'Variable','name': {'kind': 'Name','value': 'searchTerm'}}}, {'kind': 'Argument','name': {'kind': 'Name','value': 'pageSize'},'value': {'kind': 'Variable','name': {'kind': 'Name','value': 'pageSize'}}}, {'kind': 'Argument','name': {'kind': 'Name','value': 'page'},'value': {'kind': 'Variable','name': {'kind': 'Name','value': 'page'}}}, {'kind': 'Argument','name': {'kind': 'Name','value': 'sortBy'},'value': {'kind': 'Variable','name': {'kind': 'Name','value': 'sortBy'}}}, {'kind': 'Argument','name': {'kind': 'Name','value': 'sortAscending'},'value': {'kind': 'Variable','name': {'kind': 'Name','value': 'sortAscending'}}}, {'kind': 'Argument','name': {'kind': 'Name','value': 'downloadFormat'},'value': {'kind': 'Variable','name': {'kind': 'Name','value': 'downloadFormat'}}}],'selectionSet': {'kind': 'SelectionSet','selections': [{'kind': 'Field','name': {'kind': 'Name','value': 'responseBytes'}}, {'kind': 'Field','name': {'kind': 'Name','value': 'format'}}]}}]}}]} as unknown as DocumentNode < DownloadEventsByNodeAndSearchTermQuery, DownloadCSVEventVariables >
export const DownloadMonitoringPoliciesDocument = {'kind': 'Document','definitions': [{'kind': 'OperationDefinition','operation': 'query','name': {'kind': 'Name','value': 'searchAndDownloadMonitoringPolicies'},'variableDefinitions': [{'kind': 'VariableDefinition','variable': {'kind': 'Variable','name': {'kind': 'Name','value': 'pageSize'}},'type': {'kind': 'NamedType','name': {'kind': 'Name','value': 'Int'}}}, {'kind': 'VariableDefinition','variable': {'kind': 'Variable','name': {'kind': 'Name','value': 'page'}},'type': {'kind': 'NamedType','name': {'kind': 'Name','value': 'Int!'}}}, {'kind': 'VariableDefinition','variable': {'kind': 'Variable','name': {'kind': 'Name','value': 'sortBy'}},'type': {'kind': 'NamedType','name': {'kind': 'Name','value': 'String'}}}, {'kind': 'VariableDefinition','variable': {'kind': 'Variable','name': {'kind': 'Name','value': 'sortAscending'}},'type': {'kind': 'NonNullType','type': {'kind': 'NamedType','name': {'kind': 'Name','value': 'Boolean'}}}}, {'kind': 'VariableDefinition','variable': {'kind': 'Variable','name': {'kind': 'Name','value': 'downloadFormat'}},'type': {'kind': 'NonNullType','type': {'kind': 'NamedType','name': {'kind': 'Name','value': 'DownloadFormat'}}}}],'selectionSet': {'kind': 'SelectionSet','selections': [{'kind': 'Field','name': {'kind': 'Name','value': 'searchAndDownloadMonitoringPolicies'},'arguments': [{'kind': 'Argument','name': {'kind': 'Name','value': 'pageSize'},'value': {'kind': 'Variable','name': {'kind': 'Name','value': 'pageSize'}}}, {'kind': 'Argument','name': {'kind': 'Name','value': 'page'},'value': {'kind': 'Variable','name': {'kind': 'Name','value': 'page'}}}, {'kind': 'Argument','name': {'kind': 'Name','value': 'sortBy'},'value': {'kind': 'Variable','name': {'kind': 'Name','value': 'sortBy'}}}, {'kind': 'Argument','name': {'kind': 'Name','value': 'sortAscending'},'value': {'kind': 'Variable','name': {'kind': 'Name','value': 'sortAscending'}}}, {'kind': 'Argument','name': {'kind': 'Name','value': 'downloadFormat'},'value': {'kind': 'Variable','name': {'kind': 'Name','value': 'downloadFormat'}}}],'selectionSet': {'kind': 'SelectionSet','selections': [{'kind': 'Field','name': {'kind': 'Name','value': 'responseBytes'}}, {'kind': 'Field','name': {'kind': 'Name','value': 'format'}}]}}]}}]} as unknown as DocumentNode < DownloadMonitoringPoliciesQuery, DownloadCSVMonitoringPoliciesVariables >
...
export const BuildNetworkInventoryPageDocument = {'kind': 'Document','definitions': [{'kind': 'OperationDefinition','operation': 'query','name': { 'kind': 'Name', 'value': 'BuildNetworkInventoryPage' },'variableDefinitions': [{ 'kind': 'VariableDefinition', 'variable': { 'kind': 'Variable', 'name': { 'kind': 'Name', 'value': 'page' } }, 'type': { 'kind': 'NonNullType', 'type': { 'kind': 'NamedType', 'name': { 'kind': 'Name', 'value': 'Int' } } } },{ 'kind': 'VariableDefinition', 'variable': { 'kind': 'Variable', 'name': { 'kind': 'Name', 'value': 'pageSize' } }, 'type': { 'kind': 'NamedType', 'name': { 'kind': 'Name', 'value': 'Int' } } },{ 'kind': 'VariableDefinition', 'variable': { 'kind': 'Variable', 'name': { 'kind': 'Name', 'value': 'sortAscending' } }, 'type': { 'kind': 'NonNullType', 'type': { 'kind': 'NamedType', 'name': { 'kind': 'Name', 'value': 'Boolean' } } } },{ 'kind': 'VariableDefinition', 'variable': { 'kind': 'Variable', 'name': { 'kind': 'Name', 'value': 'sortBy' } }, 'type': { 'kind': 'NamedType', 'name': { 'kind': 'Name', 'value': 'String' } } },{ 'kind': 'VariableDefinition', 'variable': { 'kind': 'Variable', 'name': { 'kind': 'Name', 'value': 'searchValue' } }, 'type': { 'kind': 'NonNullType', 'type': { 'kind': 'NamedType', 'name': { 'kind': 'Name', 'value': 'String' } } } },{ 'kind': 'VariableDefinition', 'variable': { 'kind': 'Variable', 'name': { 'kind': 'Name', 'value': 'searchType' } }, 'type': { 'kind': 'NamedType', 'name': { 'kind': 'Name', 'value': 'String' } } }],'selectionSet': {'kind': 'SelectionSet','selections': [{'kind': 'Field','name': { 'kind': 'Name', 'value': 'searchNodes' },'arguments': [{ 'kind': 'Argument', 'name': { 'kind': 'Name', 'value': 'pageSize' }, 'value': { 'kind': 'Variable', 'name': { 'kind': 'Name', 'value': 'pageSize' } } },{ 'kind': 'Argument', 'name': { 'kind': 'Name', 'value': 'page' }, 'value': { 'kind': 'Variable', 'name': { 'kind': 'Name', 'value': 'page' } } },{ 'kind': 'Argument', 'name': { 'kind': 'Name', 'value': 'sortBy' }, 'value': { 'kind': 'Variable', 'name': { 'kind': 'Name', 'value': 'sortBy' } } },{ 'kind': 'Argument', 'name': { 'kind': 'Name', 'value': 'sortAscending' }, 'value': { 'kind': 'Variable', 'name': { 'kind': 'Name', 'value': 'sortAscending' } } },{ 'kind': 'Argument', 'name': { 'kind': 'Name', 'value': 'searchValue' }, 'value': { 'kind': 'Variable', 'name': { 'kind': 'Name', 'value': 'searchValue' } } },{ 'kind': 'Argument', 'name': { 'kind': 'Name', 'value': 'searchType' }, 'value': { 'kind': 'Variable', 'name': { 'kind': 'Name', 'value': 'searchType' } } }],'selectionSet': {'kind': 'SelectionSet','selections': [{ 'kind': 'Field', 'name': { 'kind': 'Name', 'value': 'nextPage' } },{ 'kind': 'Field', 'name': { 'kind': 'Name', 'value': 'totalNodes' } }, { 'kind': 'Field', 'name': { 'kind': 'Name', 'value': 'lastPage' } },{'kind': 'Field','name': { 'kind': 'Name', 'value': 'nodesList' },'selectionSet': {'kind': 'SelectionSet','selections': [{ 'kind': 'Field', 'name': { 'kind': 'Name', 'value': 'id' } },{'kind': 'Field','name': { 'kind': 'Name', 'value': 'ipInterfaces' },'selectionSet': {'kind': 'SelectionSet','selections': [{ 'kind': 'Field', 'name': { 'kind': 'Name', 'value': 'id' } },{ 'kind': 'Field', 'name': { 'kind': 'Name', 'value': 'ipAddress' } },{ 'kind': 'Field', 'name': { 'kind': 'Name', 'value': 'nodeId' } },{ 'kind': 'Field', 'name': { 'kind': 'Name', 'value': 'snmpPrimary' } }]}},{'kind': 'Field','name': { 'kind': 'Name', 'value': 'location' },'selectionSet': {'kind': 'SelectionSet','selections': [{ 'kind': 'Field', 'name': { 'kind': 'Name', 'value': 'id' } },{ 'kind': 'Field', 'name': { 'kind': 'Name', 'value': 'location' } }]}},{'kind': 'Field','name': { 'kind': 'Name', 'value': 'tags' },'selectionSet': {'kind': 'SelectionSet','selections': [{ 'kind': 'Field', 'name': { 'kind': 'Name', 'value': 'id' } },{ 'kind': 'Field', 'name': { 'kind': 'Name', 'value': 'name' } }]}},{ 'kind': 'Field', 'name': { 'kind': 'Name', 'value': 'monitoredState' } },{ 'kind': 'Field', 'name': { 'kind': 'Name', 'value': 'monitoringLocationId' } },{ 'kind': 'Field', 'name': { 'kind': 'Name', 'value': 'nodeLabel' } },{ 'kind': 'Field', 'name': { 'kind': 'Name', 'value': 'scanType' } },{ 'kind': 'Field', 'name': { 'kind': 'Name', 'value': 'nodeAlias' } }]}}]}},{'kind': 'Field','alias': { 'kind': 'Name', 'value': 'allMetrics' },'name': { 'kind': 'Name', 'value': 'metric' },'arguments': [{ 'kind': 'Argument', 'name': { 'kind': 'Name', 'value': 'name' }, 'value': { 'kind': 'StringValue', 'value': 'response_time_msec', 'block': false } }],'selectionSet': {'kind': 'SelectionSet','selections': [{ 'kind': 'Field', 'name': { 'kind': 'Name', 'value': 'status' } },{'kind': 'Field','name': { 'kind': 'Name', 'value': 'data' },'selectionSet': {'kind': 'SelectionSet','selections': [{ 'kind': 'Field', 'name': { 'kind': 'Name', 'value': 'resultType' } },{'kind': 'Field','name': { 'kind': 'Name', 'value': 'result' },'selectionSet': { 'kind': 'SelectionSet','selections': [{ 'kind': 'Field', 'name': { 'kind': 'Name', 'value': 'metric' } },{ 'kind': 'Field', 'name': { 'kind': 'Name', 'value': 'value' } },{ 'kind': 'Field', 'name': { 'kind': 'Name', 'value': 'values' } }]}}]}} ] }}]}}]} as unknown as DocumentNode<BuildNetworkInventoryPageQuery, InventoryItemsQuery>
...
export const ListNodeEventsDocument = { 'kind': 'Document', 'definitions': [{ 'kind': 'OperationDefinition', 'operation': 'query', 'name': { 'kind': 'Name', 'value': 'ListEvents' }, 'variableDefinitions': [{ 'kind': 'VariableDefinition', 'variable': { 'kind': 'Variable', 'name': { 'kind': 'Name', 'value': 'nodeId' } }, 'type': { 'kind': 'NamedType', 'name': { 'kind': 'Name', 'value': 'Long' } } }, { 'kind': 'VariableDefinition', 'variable': { 'kind': 'Variable', 'name': { 'kind': 'Name', 'value': 'searchTerm' } }, 'type': { 'kind': 'NamedType', 'name': { 'kind': 'Name', 'value': 'String' } } }, { 'kind': 'VariableDefinition', 'variable': { 'kind': 'Variable', 'name': { 'kind': 'Name', 'value': 'pageSize' } }, 'type': { 'kind': 'NamedType', 'name': { 'kind': 'Name', 'value': 'Int' } } }, { 'kind': 'VariableDefinition', 'variable': { 'kind': 'Variable', 'name': { 'kind': 'Name', 'value': 'page' } }, 'type': { 'kind': 'NamedType', 'name': { 'kind': 'Name', 'value': 'Int!' } } }, { 'kind': 'VariableDefinition', 'variable': { 'kind': 'Variable', 'name': { 'kind': 'Name', 'value': 'sortBy' } }, 'type': { 'kind': 'NamedType', 'name': { 'kind': 'Name', 'value': 'String' } } }, { 'kind': 'VariableDefinition', 'variable': { 'kind': 'Variable', 'name': { 'kind': 'Name', 'value': 'sortAscending' } }, 'type': { 'kind': 'NonNullType', 'type': { 'kind': 'NamedType', 'name': { 'kind': 'Name', 'value': 'Boolean' } } } }], 'selectionSet': { 'kind': 'SelectionSet', 'selections': [{ 'kind': 'FragmentSpread', 'name': { 'kind': 'Name', 'value': 'EventsByNodeIdParts' } }] } }, ...EventsByNodeIdPartsFragmentDoc.definitions] } as unknown as DocumentNode<EventsByNodeIdPartsQuery, ListEventsQueryVariables>
...
export const UpsertSimpleMonitoredEntityDocument = {'kind': 'Document','definitions': [{'kind': 'OperationDefinition','operation': 'mutation','name': {'kind': 'Name','value': 'upsertSimpleMonitoredEntity'},'variableDefinitions': [{'kind': 'VariableDefinition','variable': {'kind': 'Variable','name': {'kind': 'Name','value': 'locationId'}},'type': {'kind': 'NonNullType','type': {'kind': 'NamedType','name': {'kind': 'Name','value': 'Long'}}}}, {'kind': 'VariableDefinition','variable': {'kind': 'Variable','name': {'kind': 'Name','value': 'name'}},'type': {'kind': 'NonNullType','type': {'kind': 'NamedType','name': {'kind': 'Name','value': 'String'}}}}, {'kind': 'VariableDefinition','variable': {'kind': 'Variable','name': {'kind': 'Name','value': 'type'}},'type': {'kind': 'NonNullType','type': {'kind': 'NamedType','name': {'kind': 'Name','value': 'String'}}}}, {'kind': 'VariableDefinition','variable': {'kind': 'Variable','name': {'kind': 'Name','value': 'config'}},'type': {'kind': 'NonNullType','type': {'kind': 'NamedType','name': {'kind': 'Name','value': 'String'}}}}],'selectionSet': {'kind': 'SelectionSet','selections': [{'kind': 'Field','name': {'kind': 'Name','value': 'upsertSimpleMonitoredEntity'},'arguments': [{'kind': 'Argument','name': {'kind': 'Name','value': 'entity'},'value': {'kind': 'ObjectValue','fields': [{'kind': 'ObjectField','name': {'kind': 'Name','value': 'locationId'},'value': {'kind': 'Variable','name': {'kind': 'Name','value': 'locationId'}}}, {'kind': 'ObjectField','name': {'kind': 'Name','value': 'name'},'value': {'kind': 'Variable','name': {'kind': 'Name','value': 'name'}}}, {'kind': 'ObjectField','name': {'kind': 'Name','value': 'type'},'value': {'kind': 'Variable','name': {'kind': 'Name','value': 'type'}}}, {'kind': 'ObjectField','name': {'kind': 'Name','value': 'config'},'value': {'kind': 'Variable','name': {'kind': 'Name','value': 'config'}}}]}}],'selectionSet': {'kind': 'SelectionSet','selections': [{'kind': 'Field','name': {'kind': 'Name','value': 'id'}}, {'kind': 'Field','name': {'kind': 'Name','value': 'locationId'}}, {'kind': 'Field','name': {'kind': 'Name','value': 'name'}}, {'kind': 'Field','name': {'kind': 'Name','value': 'type'}}, {'kind': 'Field','name': {'kind': 'Name','value': 'config'}}, {'kind': 'Field','name': {'kind': 'Name','value': 'monitoredEntityId'}}]}}]}}]} as unknown as DocumentNode < UpsertSimpleMonitoredEntityMutation, UpsertSimpleMonitoredEntityVariables >
