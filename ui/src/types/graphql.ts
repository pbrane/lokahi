...
export type EventsByNodeIdPartsFragment = { __typename?: 'Query', searchEvents?: { __typename?: 'ListEventResponse', nextPage: number, lastPage: number, totalEvents: number, eventsList?: Array<{ __typename?: 'Event', id: number, uei?: string, nodeId: number, ipAddress?: string, producedTime: any }> } }
