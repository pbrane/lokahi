...
export type EventsByNodeIdPartsFragment = { __typename?: 'Query', searchEvents?: { __typename?: 'ListEventResponse', nextPage: number, lastPage: number, totalEvents: number, eventsList?: Array<{ __typename?: 'Event', id: number, description?: string, locationName?: string, label?: string, uei?: string, nodeId: number, ipAddress?: string, producedTime: any }> } }
