...
public interface AzureActiveDiscoveryRepository extends JpaRepository<AzureActiveDiscovery, Long> {
    ...
    Optional<AzureActiveDiscovery> findByTenantIdAndSubscriptionIdAndDirectoryIdAndClientId(
            String tenantId, String subscriptionId, String directoryId, String clientId);
}
