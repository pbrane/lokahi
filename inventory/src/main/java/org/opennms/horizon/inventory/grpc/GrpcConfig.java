...
public class GrpcConfig {
    ...
    public GrpcServerManager startServer(MonitoringLocationGrpcService locationGrpc, MonitoringSystemGrpcService systemGrpc,
                                         ...
                                         DiscoveryConfigGrpcService discoveryConfigGrpcService, PassiveDiscoveryGrpcService passiveDiscoveryGrpcService) {
        GrpcServerManager manager = new GrpcServerManager(port, interceptor);
        manager.startServer(locationGrpc, systemGrpc, nodeGrpcService, azureCredentialGrpcService, tagGrpcService, discoveryConfigGrpcService, passiveDiscoveryGrpcService);
        return manager;
    }
}
