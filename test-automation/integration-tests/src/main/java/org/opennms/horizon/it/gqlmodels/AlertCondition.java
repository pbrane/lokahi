...
public class AlertCondition {
    ...
    public AlertEventDefinitionInput getClearEvent() { return clearEvent; }
    public void setClearEvent(AlertEventDefinitionInput clearEvent) { this.clearEvent = clearEvent; }
    ...
    public AlertEventDefinitionInput getTriggerEvent() { return triggerEvent; }
    public void setTriggerEvent(AlertEventDefinitionInput triggerEvent) { this.triggerEvent = triggerEvent; }
